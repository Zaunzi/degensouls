<script lang="ts">
	import Logo from '$lib/images/degen-mafia-banner-logo.png'
</script>

<div class="mt-10 pt-10 container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<div>
		<img class="object-scale-down max-w-5xl" alt="degen logo" src={Logo} />
		</div>
		<!-- Animated Logo -->
		<figure>
			<section class="img-bg" />
			<svg
				class="fill-secondary -scale-x-[100%]"
		...
		<div class="flex justify-center space-x-2">
			<a 
			href="https://discord.gg/F62cEvrDwv"
			target="_blank"
			rel="noreferrer"
			>
			<button type="button" class="btn bg-gradient-to-br variant-gradient-primary-secondary">Join Community</button>
			</a>
		</div>
	</div>
</div>
